...
test                = False               # set some conditions for easier testing

# dir & file
dataDirectory       = "/data/"            # the data subdirectory to the program directory
shareDirectory      = "/gres/"            # where the icons and sounds reside
dataPath            = None                # file path to data dir
sharePath           = None                # file path to the icons and sounds
