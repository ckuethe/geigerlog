...
Start with: path/to/Simul_WifiServer.py
Stop  with: CTRL-C
...
## Display name
DisplayName    = "GeigerLog Simul_WifiServer"

# Filename of log file
Logfile        = ""                       # if left empty a log file will NOT be written
# Logfile      = "Simul_WifiServer.log"     # the log file will be in the directory from
                                          # where you started Simul_WifiServer
#
...
class MyServer(MyHandler):
    ...
    def do_GET(self):
        ...
        # dprint(defname + "self.path: ", self.path)
        ...
        # page not found 404 error
            ...
            dogetmsg   = "{} | {}{} {}".format(color, defname, answer, TDEFAULT)
...
def getDataCSV(avg):
    ...
    vprint("Simul_WifiServer: {:125s}  dur:{:0.2f} ms".format(lastrec, duration))
